...
import type { RouteAssignmentStatistics } from "../types/routeAssignmentTypes";
...
export function StatisticsCards({ statistics }: StatisticsCardsProps) {
  const cards = [
    ...
    },
    {
      ...
      value: statistics.activeAssignments,
      description: "Actualmente activas",
      icon: CheckCircle,
      iconColor: "text-green-500"
    },
    {
      title: "Asignaciones Inactivas",
      value: statistics.inactiveAssignments,
